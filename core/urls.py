...
urlpatterns = [
    ...
    path('chat/video/<uuid:video_id>/', views.chat_video_detail, name='chat_video_detail'),
    path('chat/video/<uuid:video_id>/download/', views.download_chat_video, name='download_chat_video'),
